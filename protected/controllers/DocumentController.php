 ...
 $columns = array(       
      //  array('name'=>'protocol_number'),
        array(
            ...
            'type'=>'raw',
            'value'=>'CHtml::ajaxLink($data->publication_number?$data->publication_number:\'n/d\',array("document/view","id"=>$data->id), array("update"=>"#detail", "beforeSend" => "function() { $(\'#detail\').addClass(\'loading\'); $(\'html body\').animate({scrollTop: $(\'a[name=detail-view]\').offset().top }, 1000); }") )',
            ),   
        array('name'=>'subject'),
       array('name'=>'act_date'),
