...
<table class="table table-striped table-condensed document-item-view detail-view">
    ...
    <tr>
        <td style="width: 30%"><label><?php echo $model->getAttributeLabel('title'); ?></label></td>
        <td><p><?php echo CHtml::encode($data->title); ?></p></td>
    </tr>

    <tr>
        <td style="width: 30%"><label><?php echo $model->getAttributeLabel('receiver'); ?></label></td>
        <td><p><?php echo CHtml::encode($data->receiver); ?></p></td>        
    </tr>
    
    <tr>
        <td style="width: 30%"><label><?php echo $model->getAttributeLabel('amount'); ?></label></td>
        <td><p><?php echo CHtml::encode($data->amount)  ?> €</p></td>
    </tr>

    <tr>
        <td style="width: 30%"><label><?php echo $model->getAttributeLabel('spending_date'); ?></label></td>
